...
import { useAuthRefresh } from '@/components/AuthCheck';
...
export default function Setup() {
  ...
  const refreshAuthStatus = useAuthRefresh();
    ...
    try {
      ...
      if (response.success) {
        ...
        if (!isDesktop()) {
          ...
          // AuthCheck's status is still stale ('setup') until this refreshes —
          // without it, navigate('/') gets bounced straight back to /setup.
