              ...
              <DataMatrix
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    cell: (c) => (
                      <span className="font-mono tabular-nums text-[var(--kb-red)]">
                        ...
                        {c.summary.maxDrawdownAbs != null &&
                          c.summary.maxDrawdownAbs < 0 && (
                            <span className="ml-1 text-[10px]">
                              {money(c.summary.maxDrawdownAbs)}
                            </span>
                          )}
                      </span>
                    ),
                  },
                  {
                    ...
                    cell: (c) => (
                      <span
                        className={`font-mono tabular-nums ${pnlClass(c.summary.netPnl)}`}
                      >
