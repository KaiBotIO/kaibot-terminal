...
import m032 from './migrations/032_execution_account.sql' with { type: 'text' }
import m033 from './migrations/033_hedge_guards.sql' with { type: 'text' }
import m034 from './migrations/034_synthetic_usd_armed.sql' with { type: 'text' }
import m035 from './migrations/035_exchange_connection_label.sql' with { type: 'text' }
import m036 from './migrations/036_signal_ack.sql' with { type: 'text' }
import m037 from './migrations/037_deferred_entries.sql' with { type: 'text' }
import m038 from './migrations/038_stop_floor.sql' with { type: 'text' }
import m039 from './migrations/039_signal_account_outcomes.sql' with { type: 'text' }
import m040 from './migrations/040_fill_fee_native.sql' with { type: 'text' }
import m041 from './migrations/041_user_roles.sql' with { type: 'text' }
...
const assets: Record<string, string> = {
  ...
  'migrations/032_execution_account.sql': m032,
  'migrations/033_hedge_guards.sql': m033,
  'migrations/034_synthetic_usd_armed.sql': m034,
  'migrations/035_exchange_connection_label.sql': m035,
  'migrations/036_signal_ack.sql': m036,
  'migrations/037_deferred_entries.sql': m037,
  'migrations/038_stop_floor.sql': m038,
  'migrations/039_signal_account_outcomes.sql': m039,
  'migrations/040_fill_fee_native.sql': m040,
  'migrations/041_user_roles.sql': m041,
}
