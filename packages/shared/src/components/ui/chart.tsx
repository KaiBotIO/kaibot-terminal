...
// Static import is intentional: this is a shared component library. Code-splitting
// recharts must happen at the consumer's render site, not here (lazy() would change
// the public API to require Suspense boundaries everywhere).
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload.reduce<React.ReactNode[]>(
          (acc, item, index) => {
          if (item.type === "none") {
            return acc
          }
