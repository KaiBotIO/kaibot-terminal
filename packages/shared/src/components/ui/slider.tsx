...
function Slider({
  ...
  return (
    ...
    >
      ...
      {/* Slider thumbs are strictly positional: Radix maps each thumb to a fixed
          value-array index. They are never reordered/filtered, and two thumbs can
          share the same value, so positional index is the only correct stable key. */}
      {_values.map((_, index) => (
